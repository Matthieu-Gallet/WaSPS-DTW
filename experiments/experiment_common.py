"""Shared infrastructure for experiments/run_*.py.
...
extracted from run_sensitivity.py so run_classification.py, run_barycenters.py,
run_optim_hyper.py, run_sensitivity.py, and run_full_baseline.py all share
identical parameter handling, logging, and metrics/timing recording.
